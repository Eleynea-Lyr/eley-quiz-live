...
/** i tout en courbes — pastille douce, sans liséré */
function InfoIcon({ size = 28 }) {
  return (
    <svg
      ...
      style={{ display: "block" }}
    >
      <circle cx="16" cy="16" r="15" fill="rgba(255, 251, 245, 0.14)" />
      <circle cx="16" cy="9.2" r="2.15" fill="rgba(255, 251, 245, 0.92)" />
      <rect x="13.85" y="13.2" width="4.3" height="11.2" rx="2.15" fill="rgba(255, 251, 245, 0.92)" />
    </svg>
  );
}
