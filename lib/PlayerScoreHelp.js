...
function MiniPlayerBadge() {
  return (
    ...
    >
      ...
      <span style={{ color: BRAND.yellow }}>⚡ 5</span>
    </div>
  );
}
...
function BuzzLegend() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 8, marginTop: 4 }}>
      ...
      {row(BRAND.mauveLight, "Gris — un autre joueur a buzzé")}
  ...
  if (page === 0) {
    return (
      <>
        ...
        <p style={bodyStyle}>{m.page1Lead}</p>
