...
/** i arrondi centré — pastille douce, sans liséré */
function InfoIcon({ size = 40 }) {
  return (
    <svg
      ...
      style={{ display: "block" }}
    >
      {/* Fond violet un peu plus clair */}
      <circle cx="20" cy="20" r="18.5" fill="rgba(120, 72, 150, 0.42)" />
      {/* i arrondi, centré */}
      <circle cx="20" cy="11.4" r="2.7" fill="rgba(255, 251, 245, 0.96)" />
      <rect
        x="17.35"
        y="16.2"
        width="5.3"
