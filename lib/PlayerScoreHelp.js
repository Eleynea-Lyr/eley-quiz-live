...
function MiniPlayerBadge({ highlight = "player" }) {
  ...
  return (
    <div
      ...
      aria-hidden="true"
    >
      <span style={{ opacity: dimPlayer ? 0.18 : 1 }}>👤 Toi</span>
      <span
        style={{
...
/** i arrondi + petite forme à droite — pastille douce, sans liséré */
function InfoIcon({ size = 40 }) {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      {/* Fond doux */}
      <circle cx="20" cy="20" r="18.5" fill="rgba(255, 251, 245, 0.16)" />
      {/* i arrondi (légèrement à gauche) */}
      <circle cx="16.5" cy="11.2" r="2.6" fill="rgba(255, 251, 245, 0.95)" />
      <rect
        x="14"
        y="16"
        width="5.1"
      ...
      />
      {/* Petite forme arrondie à droite du i */}
      <ellipse
        cx="26.4"
        cy="22.2"
        rx="3.4"
