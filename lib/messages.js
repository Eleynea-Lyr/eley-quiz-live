...
export const ELEYBUZZ_PLAYER_MESSAGES = {
  ...
  // Punition
  punishment: "T'es puni ! Tu perds 2 points ! Il fallait donner la bonne réponse ! Attends quelques secondes ou qu'un autre joueur se trompe également avant de rebuzzer.",
