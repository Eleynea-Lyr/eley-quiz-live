...
export const PLAYER_SCORE_HELP = {
  ...
  page2Lead: "En parallèle, toi aussi tu marques des points perso.",
  page2Body: "Plus tu réponds vite et juste, plus tu grimpes au classement joueurs.",
  page2Caption: "Badge en haut à droite",
  page2Note: "Score équipe (gauche) ≠ score perso (droite). Les deux comptent pour la soirée.",
  page3Title: "Le mode ⚡ EleyBuzz :",
  page3Lead: "Quand le gros bouton bleu apparaît : buzz pour tenter de répondre.",
  page3Body:
    "Bonne réponse → points bonus ⚡ sur ton score perso. Mauvaise réponse → tu perds un peu de points… et tu attends la question suivante.",
  page3Caption: "Badge en haut à droite — la partie ⚡",
  page3Close:
    "En fin de soirée, l’animateur peut ajouter ces points ⚡ (bonus ou malus) à ton score joueur. Ça ne change pas le score de l’équipe.",
};
